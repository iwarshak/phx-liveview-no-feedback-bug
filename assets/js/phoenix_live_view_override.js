console.log('overridden from https://github.com/phoenixframework/phoenix_live_view/blob/v0.17.4/priv/static/phoenix_live_view.esm.js')
...
var DOM = {
  ...
  discardError(container, el, phxFeedbackFor) {
    ...
    console.log("discardError no_feedback", input, field)
    if (!input) {
      return;
    }
    if (!(this.private(input, PHX_HAS_FOCUSED) || this.private(input.form, PHX_HAS_SUBMITTED))) {
      console.log(`${field} adding no_feedback`)
      el.classList.add(PHX_NO_FEEDBACK_CLASS);
    } else {
      // debugger
      console.log(`${field} NOT adding no_feedback PHX_HAS_FOCUSED: ${this.private(input, PHX_HAS_FOCUSED)} PHX_HAS_SUBMITTED: ${this.private(input.form, PHX_HAS_SUBMITTED)}`)
    }
  },
  showError(inputEl, phxFeedbackFor) {
    if (inputEl.id || inputEl.name) {
      this.all(inputEl.form, `[${phxFeedbackFor}="${inputEl.id}"], [${phxFeedbackFor}="${inputEl.name}"]`, (el) => {
        console.log(`${inputEl} REMOVING no_feedback`)
        this.removeClass(el, PHX_NO_FEEDBACK_CLASS);
      });
    } else {
      console.log(`${inputEl} NOT REMOVING no_feedback`)
    }
  },
  isPhxChild(node) {
...
var DOMPatch = class {
    ...
    liveSocket.time("morphdom", () => {
      morphdom_esm_default(targetContainer, diffHTML, {
        ...
        onNodeAdded: (el) => {
          ...
          console.log("yoo onNodeAdded ", el)
          added.push(el);
        },
        onNodeDiscarded: (el) => {
          ...
          console.log("yoo onNodeDiscarded ", el)
        ...
        onElUpdated: (el) => {
          ...
          console.log("yoo onElUpdated ", el)
  ...
  buildDiffHTML(container, html, phxUpdate, targetContainer) {
    ...
    if (!isCIDPatch || isCIDWithSingleRoot) {
      ...
      console.log("phx_component buildDiffHTML")
...
`, template.innerHTML.trim());
  ...
  createSpan(text, cid) {
    ...
    console.log("phx_component createSpan")
    return span;
  }
};
...
var View = class {
  ...
  afterElementsRemoved(elements, pruneCids) {
    ...
    console.log("phx_component afterElementsRemoved", destroyedCIDs)
    if (pruneCids) {
